export const Hero = () => {
  return (
    <section className="py-24" id="home">
      <div className="px-4  lg:max-w-4xl max-w-4xl mx-auto flex flex-col items-center overflow-hidden relative [mask-image:linear-gradient(to_right,transparent,black_20%,black_80%,transparent)]">
   ...
   Javascript, React.js, and Next.js...
        ...
        <a href="#contact" className="bg-neutral-900 px-7 py-2 mt-4 border border-white/15 rounded-full cursor-pointer text-white font-medium text-lg"> Let&apos;s Contact Now</a>
      </div>
    </section>
  );
};
